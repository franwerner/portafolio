...
const BootstrapSVG = (props) => (
    ...
    >
        ...
        >
            ...
            <stop offset={0.011} stopColor="#68369f" />
            <stop offset={0.135} stopColor="#773db6" />
            <stop offset={0.193} stopColor="#8042c3" />
            <stop offset={0.248} stopColor="#8343c8" />
            <stop offset={0.388} stopColor="#8444c9" />
            <stop offset={0.732} stopColor="#9751d2" />
            <stop offset={0.997} stopColor="#9c55d4" />
            <stop offset={0.998} stopColor="#9c55d4" />
